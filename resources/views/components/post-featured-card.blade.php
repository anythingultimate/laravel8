        ...
        <div class="flex-1 flex flex-col justify-between">
            ...
            <footer class="flex justify-between items-center mt-8">
                <div class="flex items-center text-sm">
                    ...
                    <div class="ml-3" style="max-width: 220px;">
                ...
                <div class="hidden lg:block">
                    <a href="/posts/{{ $post->slug }}" class="transition-colors duration-300 text-xs font-semibold bg-gray-200 hover:bg-gray-300 rounded-full py-2 px-6">Read More</a>
                </div>
            </footer>
        </div>
    </div>
